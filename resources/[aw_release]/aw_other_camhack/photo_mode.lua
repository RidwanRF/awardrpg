...
SMOOTH_MOVEMENT_SPEED = 0.001
SMOOTH_LOOK_SPEED = 0.001
...
function enablePhotoMode()
    setElementData(localPlayer, "showSpeedometer", false)
    setElementData(localPlayer, "showHud", false)
    setElementData(localPlayer, "showRadar", false)
	hud = exports.aw_interface_hud:anim_true()
	radar = exports.aw_interface_radar:anim_true()
	speed = exports.aw_interface_speedometer:anim_true()
	showChat (false)
...
function disablePhotoMode()
	...
	speed = exports.aw_interface_speedometer:anim_false()
	for i, name in ipairs(controlList) do
...
bindKey(PHOTO_MODE_KEY, "down", function ()
	if getKeyState ("lshift") then return end
...
addCommandHandler('camhack', toggleCam)
