...
local circleShader = dxCreateShader ( "assets/fx/hou_circle.fx" )
local fuelCircleShader = dxCreateShader ( "assets/fx/fuel_circle.fx" )
local otherCircleShader = dxCreateShader ( "assets/fx/circle.fx" )
local pos_start = {}
local pos_stop = {}
...
local maskShader = dxCreateShader ( "assets/fx/hud_mask.fx" )

local circle = dxCreateTexture ( "assets/aw_ui_speedometer_speedmask.png" )


local renders = dxCreateRenderTarget (300*px, 300*px, true)

function hou_circle( x, y, width, height, rot, color, angleStart, angleSweep, borderWidth )
