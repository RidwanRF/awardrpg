...
float4 PixelShaderFunction(PSInput PS) : COLOR0
{
    ...
    float brightnessFactor = 7.00; // the default value is 0.10
    float normalPerturbation = 0.00;
    float microflakePerturbationA = 0.0;
    ...
    finalColor.a = setAlphaChanel;

    // Bodge in the car colors
    float4 Color = 0;
    Color = finalColor / 2 + PS.Diffuse * 0.5;
    Color += 0;
    Color *= 0.1; // If you don't want to see the dirt texture just delete that line
    Color.a = setAlphaChanel;
