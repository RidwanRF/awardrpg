...
function updateRights ( loggedin, admin, canAccess, vip )
    pData.loggedin = loggedin
    pData.isadmin = admin
    pData.access = canAccess
    pData.vip = vip
    outputDebugString ( "Updated rights: loggedin:"..tostring(loggedin).." | isadmin:"..tostring(admin) .. " | access:" .. tostring(canAccess) .. " | vip:" .. tostring(vip))
