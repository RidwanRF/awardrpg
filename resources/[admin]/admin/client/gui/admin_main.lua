...
local textes = [[  
~ Наказания для правонарушителей ~

Общие правила:
1.1 Использование любых программ дающие нечестное преимущество в игре — [Тюрьма на 30 дней]
1.2 Без причины убивать игроков — [Тюрьма на 2 часа]
1.3 Неудобства другим игрокам, злоупотребляя возможностями игрового режима — [Тюрьма на 1 час]
1.4 Вводить игроков в заблуждение с целью мошенничества — [Тюрьма на 2 дня]
1.5 Если игрок выдает себя за членов администрации — [Тюрьма на 5 дней]
1.6 Любой вида багоюза — [Тюрьма на 1 час]
1.6.1 Обход автоМута причисляется к багоюзу — [Тюрьма на 3 дня]
1.7 Обход автоМута причисляется к багоюзу — [Тюрьма 3 дней]
1.8 Продажа аккаунта, передача другому — [Тюрьма навсегда + обнуление аккаунта]
1.9 Обман администрации — [Тюрьма на 7 дней]
1.10 Невыполнение требований администрации — [Тюрьма на 12 часов]
1.11 Нецензурная лексика и оскорбления в объявлениях — [Тюрьма на 6-12 часов]
1.12 Дрифт и помеха другим игрокам на ЕКХ — [Тюрьма на 30 минут]
1.13 Если специально таранят — [Тюрьма на 2 часа]
1.14 Обмен игровых предметов на реальные деньги — [Тюрьма на 14 дней]
1.15 Помеха игровому процессу — [Тюрьма на 2 часа]
1.16 Срыв Мероприятия — [Тюрьма на 30 минут]
1.17 Обсуждение действий администратора — [Мут на 5 минут]

Чат: 
2.1 Использование чужих никнеймов — [Тюрьма на 7 дней]
2.2 Использование никнейма, содержащий любого рода оскорбление — [Мут + Предупреждение]
2.3 Использование никнейма администрации (копия) — [Тюрьма на 30 дней] 
2.4 Использование "пустых ников" (например один символ)" — [Кик + Предупреждение игроку]
2.5 Реклама сторонних проектов — [Тюрьма НАВСЕГДА]
2.6 Флуд в чат — [Мут от 5 минут] 
2.7 Оскорбление близких людей игрока — [Тюрьма на 2-10 дней]
2.8 Любые проявления расизма и нацизма — [Тюрьма на 15-30 дней]


~ Администраторам сервера запрещается ~

3.3 Продавать свой аккаунт — [Снятие c админки + удаление аккаунта]
3.4 Сменить ник не предупредив основателя — [Предупреждение/Выговор]
3.5 Угрозы игрокам — [Предупреждение/Выговор] 
3.6 Тюрьмаить/Кикать/Сажать игрока(ов) из личной неприязни — [Тюрьма на 5 дней]
3.7 Выдавать игроку(ам) оружие, исключение только на МП — [Тюрьма на 12 часов]
3.8 Пользоваться привилегиями во время мероприятия или захват территории — [Тюрьма на 2 дня] 
3.9 Оскорблять других модераторов/администраторов — [Выговор] 
3.10 Использовать миниган и тому подобное на сервере — [Выговор] 
3.11 Использовать админ-тег для свободного общения — [Предупреждение]


Администратор будет снят, если наберёт 3 выговора. 

Обязанности администратора сервера: 
Администратор сервера должен следить за порядком на сервере (предотвращать). 
Администратор сервера должен помогать игрокам по мере возможности . 
Администратор сервера должен следить за войнами Тюрьмад (предотвращать багоюз). 
Администратор сервера должен сообщать о нарушениях со стороны других администраторов.  
Администратор сервера должен отвечать на каждую жалобу в репорт. 

При систематическом невыполнении обязанностей Администратора - снятие с должности! 
Все нарушения и действия Администрации записываться в ЛОГ сервера, не надейтесь на "не запалят"


~ Основные команды для Администраторов ~ 
/fly - летать по карте ( WASD, CTRL, ЛКМ, ПРОБЕЛ)
/warpmap - моментальный телепорт по карте  
/toggletag - включить/отключить тег
]]
...
function aAdminMenu ()
	if ( aAdminForm == nil ) then
		...
		aAdminForm			= guiCreateWindow ( (x-750)/2, (y-600)/2, 750, 600, "", false ) --guiCreateWindow ( x / 2 - 310, y / 2 - 260, 620, 520, "", false )
							guiWindowSetSizable ( aAdminForm, false )
						    guiSetText ( aAdminForm, "Админ панель" )
						    guiCreateLabel ( 0.78, 0.05, 0.45, 0.04, "", true, aAdminForm )
		
		aTabPanel			= guiCreateTabPanel ( 0.01, 0.05, 0.98, 0.95, true, aAdminForm )
		aTab1 = {}	
		aTab1.Tab			= guiCreateTab ( "Игроки", aTabPanel, "players" )
		aTab1.Messages		= guiCreateButton ( 0.71, 0.02, 0.27, 0.04, "0/0 сообщения", true, aTab1.Tab )
		aTab1.ScreenShots	= guiCreateButton ( 0.71, 0.065, 0.27, 0.04, "Скриншоты", true, aTab1.Tab )

		aTab1.PlayerListSearch 	= guiCreateEdit ( 0.02, 0.02, 0.22, 0.04, "", true, aTab1.Tab )
		aTab1.HideColorCodes    = guiCreateCheckBox ( 0.02, 0.945, 0.20, 0.04, "Цветовой код", true, true, aTab1.Tab )
		aTab1.PlayerList		= guiCreateGridList ( 0.02, 0.07, 0.22, 0.87, true, aTab1.Tab )
						  guiGridListAddColumn( aTab1.PlayerList, "Онлайн игроки", 0.85 )
		...
		aTab1.Kick			= guiCreateButton ( 0.71, 0.125, 0.13, 0.04, "Кикнуть", true, aTab1.Tab, "kick" )
		aTab1.Ban			= guiCreateButton ( 0.85, 0.125, 0.13, 0.04, "Забанить", true, aTab1.Tab, "ban" )
		aTab1.Mute			= guiCreateButton ( 0.71, 0.170, 0.13, 0.04, "Мут", true, aTab1.Tab, "mute" )
		aTab1.Freeze		= guiCreateButton ( 0.85, 0.170, 0.13, 0.04, "Фриз", true, aTab1.Tab, "freeze" )
		aTab1.Spectate		= guiCreateButton ( 0.71, 0.215, 0.13, 0.04, "Следить", true, aTab1.Tab, "spectate" )
		aTab1.Slap			= guiCreateButton ( 0.85, 0.215, 0.13, 0.04, "Слап "..aCurrentSlap.." _", true, aTab1.Tab, "slap" )
		...
		aTab1.Nick			= guiCreateButton ( 0.71, 0.260, 0.13, 0.04, "Новый ник", true, aTab1.Tab )
		aTab1.Shout			= guiCreateButton ( 0.85, 0.260, 0.13, 0.04, "Сказать", true, aTab1.Tab, "shout" )
		aTab1.Admin			= guiCreateButton ( 0.71, 0.305, 0.27, 0.04, "Дать админ права", true, aTab1.Tab, "setgroup" )
	
		local y = 0.025		-- Start y coord
		local A = 0.035		-- Large line gap
		local B = 0.035		-- Small line gap

						      guiCreateHeader ( 0.26, y, 0.20, 0.04, "Информация игрока:", true, aTab1.Tab )
y=y+A   aTab1.Name			= guiCreateLabel ( 0.26, y, 0.30, 0.035, "Ник: N/A", true, aTab1.Tab )
...
y=y+A   aTab1.Serial		= guiCreateLabel ( 0.26, y, 0.435, 0.035, "Скриал: N/A", true, aTab1.Tab )
y=y+B   aTab1.Accountname	= guiCreateLabel ( 0.26, y, 0.435, 0.035, "Логин: N/A", true, aTab1.Tab )
y=y+B   aTab1.Groups		= guiCreateLabel ( 0.26, y, 0.435, 0.035, "ACL: N/A", true, aTab1.Tab )



B = 0.035
y=y+A  				         guiCreateHeader ( 0.26, y, 0.20, 0.04, "Игровой процесс:", true, aTab1.Tab )
y=y+A   aTab1.Health		= guiCreateLabel ( 0.26, y, 0.20, 0.04, "Жизни: 0%", true, aTab1.Tab )
		aTab1.Armour		= guiCreateLabel ( 0.45, y, 0.20, 0.04, "Броня: 0%", true, aTab1.Tab )
y=y+B   aTab1.Skin			= guiCreateLabel ( 0.26, y, 0.20, 0.04, "Скин: N/A", true, aTab1.Tab )
y=y+B   aTab1.Weapon		= guiCreateLabel ( 0.26, y, 0.35, 0.04, "Оружие: N/A", true, aTab1.Tab )
y=y+B   aTab1.Area			= guiCreateLabel ( 0.26, y, 0.44, 0.04, "Местоположение: Неизвестно", true, aTab1.Tab )
y=y+B   aTab1.Dimension		= guiCreateLabel ( 0.26, y, 0.20, 0.04, "Измерение: 0", true, aTab1.Tab )
		aTab1.Interior		= guiCreateLabel ( 0.45, y, 0.20, 0.04, "Интерьер: 0", true, aTab1.Tab )
y=y+B   aTab1.Money			= guiCreateLabel ( 0.26, y, 0.20, 0.04, "Наличка: 0", true, aTab1.Tab )
y=y+B   aTab1.MoneyBankRub	= guiCreateLabel ( 0.26, y, 0.25, 0.04, "Банк: 0", true, aTab1.Tab )
y=y+B   aTab1.Donate	    = guiCreateLabel ( 0.26, y, 0.25, 0.04, "Донат счет: 0", true, aTab1.Tab )

guiLabelSetColor ( aTab1.Money, 51, 153, 51)
guiLabelSetColor ( aTab1.MoneyBankRub, 51, 153, 51)
guiLabelSetColor ( aTab1.Donate, 255, 51, 51)


y=y+A  				          guiCreateHeader ( 0.26, y, 0.20, 0.04, "Транспорт:", true, aTab1.Tab )
y=y+B  aTab1.Vehicle		= guiCreateLabel ( 0.26, y, 0.44, 0.08, "Транспорт: N/A", true, aTab1.Tab )
	                          guiLabelSetHorizontalAlign(aTab1.Vehicle, "left", true)
y=y+B aTab1.VehicleHealth	= guiCreateLabel ( 0.26, y, 0.44, 0.04, "HP: 0%", true, aTab1.Tab )

y=y+A  				          guiCreateHeader ( 0.26, y, 0.32, 0.04, "Доп. возможности для основателя:", true, aTab1.Tab ) --setDonateMoney, setBankMoney, setdonateminus, setbankminus, uplevel, setsex, setparkmesta, minuspark
y=y+A+0.005 aTab1.giveDonate      	    = guiCreateButton ( 0.26, y, 0.20, 0.045, "Выдать донат", true, aTab1.Tab, "setDonateMoney" )
            aTab1.giveBank      	    = guiCreateButton ( 0.47, y, 0.20, 0.045, "Выдать деньги на банковский счет", true, aTab1.Tab, "setBankMoney" )
y=y+A+0.015 aTab1.delallDonate      	= guiCreateButton ( 0.26, y, 0.20, 0.045, "Обнулить донат", true, aTab1.Tab, "setdonateminus" )
            aTab1.delallBank      	    = guiCreateButton ( 0.47, y, 0.20, 0.045, "Обнулить весь банковский счет", true, aTab1.Tab, "setbankminus" )
y=y+A+0.015 aTab1.givePark      	    = guiCreateButton ( 0.26, y, 0.20, 0.045, "Выдать парк. места", true, aTab1.Tab, "setparkmesta" )
            aTab1.minusPark      	    = guiCreateButton ( 0.47, y, 0.20, 0.045, "Убрать парк. места", true, aTab1.Tab, "minuspark" )





		aTab1.SetHealth		= guiCreateButton ( 0.71, 0.395, 0.13, 0.04, "Здоровье", true, aTab1.Tab, "sethealth" )
		aTab1.SetArmour		= guiCreateButton ( 0.85, 0.395, 0.13, 0.04, "Броня", true, aTab1.Tab, "setarmour" )
		aTab1.SetSkin		= guiCreateButton ( 0.71, 0.440, 0.13, 0.04, "Скин", true, aTab1.Tab, "setskin" )
		aTab1.SetTeam		= guiCreateButton ( 0.85, 0.440, 0.13, 0.04, "Команда", true, aTab1.Tab, "setteam" )
		aTab1.SetDimension	= guiCreateButton ( 0.71, 0.755, 0.13, 0.04, "Измерение", true, aTab1.Tab, "setdimension" )
		aTab1.SetInterior		= guiCreateButton ( 0.85, 0.755, 0.13, 0.04, "Интерьер", true, aTab1.Tab, "setinterior" )
		aTab1.GiveWeapon		= guiCreateButton ( 0.71, 0.485, 0.27, 0.04, "Выдать оружие", true, aTab1.Tab, "giveweapon" )
		...
		aTab1.SetMoney		= guiCreateButton ( 0.71, 0.530, 0.13, 0.04, "Выдать денег", true, aTab1.Tab, "setmoney" )
		aTab1.SetStats		= guiCreateButton ( 0.85, 0.530, 0.13, 0.04, "Навыки", true, aTab1.Tab, "setstat" )
		aTab1.JetPack		= guiCreateButton ( 0.71, 0.575, 0.27, 0.04, "ДжетПак", true, aTab1.Tab, "jetpack" )
		aTab1.Warp			= guiCreateButton ( 0.71, 0.620, 0.27, 0.04, "ТП", true, aTab1.Tab, "warp" )
		aTab1.WarpTo		= guiCreateButton ( 0.71, 0.665, 0.27, 0.04, "ТП игрока..", true, aTab1.Tab, "warp" )
		aTab1.VehicleFix		= guiCreateButton ( 0.71, 0.84, 0.13, 0.04, "Починить", true, aTab1.Tab, "repair" )
		aTab1.VehicleDestroy	= guiCreateButton ( 0.71, 0.89, 0.13, 0.04, "Забрать", true, aTab1.Tab, "destroyvehicle" )
		aTab1.VehicleBlow		= guiCreateButton ( 0.85, 0.84, 0.13, 0.04, "Взорвать", true, aTab1.Tab, "blowvehicle" )
		aTab1.VehicleCustomize 	= guiCreateButton ( 0.85, 0.89, 0.13, 0.04, "Улучишть", true, aTab1.Tab, "customize" )
	--	aTab1.AnonAdmin		  = guiCreateCheckBox (0.745, 0.942, 0.20, 0.04, "Анонимный админ", isAnonAdmin(), true, aTab1.Tab )
		aTab1.GiveVehicle		= guiCreateButton ( 0.71, 0.710, 0.27, 0.04, "Выдать машину", true, aTab1.Tab, "givevehicle" )
        ...
        ---(x-750)/2, (y-600)/2, 750, 600
		aTab7 = {}
		aTab7.Tab			= guiCreateTab ( "Справочник", aTabPanel )
		scrolltab = guiCreateScrollPane(0.015, 0.02, 0.97, 0.95, true, aTab7.Tab)

        helperforAdmin = guiCreateLabel(15, 2, 600, 1250, textes, false, scrolltab)
...
function aAdminRefresh ()
	if ( guiGridListGetSelectedItem ( aTab1.PlayerList ) ~= -1 ) then
		...
		if ( player and aPlayers[player] ) then
			triggerServerEvent("refreshBalance", localPlayer, player)
			guiSetText ( aTab1.Name, "Ник: "..aPlayers[player]["name"].." ( ID: "..(getElementData(player, "idlePlayer") or 0).." )" )
			guiSetText ( aTab1.Mute, iif ( aPlayers[player]["mute"], "РазМутить", "Мут" ) )
			guiSetText ( aTab1.Freeze, iif ( aPlayers[player]["freeze"], "Разморозить", "Фриз" ) )
			...
			guiSetText ( aTab1.Accountname, "Логин: "..( aPlayers[player]["accountname"] or "" ) )
			guiSetText ( aTab1.Groups, "ACL: "..( aPlayers[player]["groups"] or "None" ) )
			--guiSetText ( aTab1.ACDetected, "AC: "..( aPlayers[player]["acdetected"] or "" ) )
			--guiSetText ( aTab1.ACD3D, "D3D9.DLL: "..( aPlayers[player]["d3d9dll"] or "" ) )
			--guiSetText ( aTab1.ACModInfo, "IMG: "..( aPlayers[player]["imgmodsnum"] or "" ) )
			if ( isPedDead ( player ) ) then guiSetText ( aTab1.Health, "HP: умер" )
			else guiSetText ( aTab1.Health, "HP: "..math.ceil ( getElementHealth ( player ) ).."%" ) end
			...
			--else guiSetText ( aTab1.Team, "Комманда: None" ) end
			--guiSetText ( aTab1.Ping, "Пинг: "..getPlayerPing ( player ) )
			guiSetText ( aTab1.Money, "Наличка: "..convertNumber((aPlayers[player]["money"]) or 0 ).."₽")
			--guiSetText ( aTab1.MoneyBankRub, "Тюрьмак: "..convertNumber((aPlayers[player]["money"]) or 0 ).."₽")xy)
 
--[[
			if isResourceRunning("bank") then
				guiSetText ( aTab1.MoneyBankRub, "Тюрьмак: " ..convertNumber(exports.bank:getPlayerBankMoney(aPlayers[player]["RUB"] or 0).."₽"))
				guiSetText ( aTab1.Donate, "Донат счет: " ..convertNumber(exports.bank:getPlayerBankDonateMoney(aPlayers[player]["DONATE"] or 0).."₽"))  
			else
				guiSetText ( aTab1.MoneyBankRub, "Тюрьмак: Тюрьмак не запущен")
				guiSetText ( aTab1.Donate, "Донат: Тюрьмак не запущен")
			end--]]
			...
			guiSetText ( aTab1.JetPack, iif ( doesPedHaveJetPack ( player ), "Забрать ДжетПак", "Выдать ДжетПак" ) )
			...
			guiSetText ( aTab1.Area, "Местоположение: "..iif ( getZoneName ( x, y, z, false ) == getZoneName ( x, y, z, true ), getZoneName ( x, y, z, false ), getZoneName ( x, y, z, false ).." ("..getZoneName ( x, y, z, true )..")" ) )
			...
			if ( vehicle ) then
				if isResourceRunning("car_system") then
					...
					if (modName ~= name) then
						guiSetText(aTab1.Vehicle, string.format("%s (SA: %s, ID: %i)", modName, name, getElementModel(vehicle)))
					else
						guiSetText(aTab1.Vehicle, name.." (ID: "..getElementModel(vehicle)..")")
					end
				else
					guiSetText(aTab1.Vehicle, getVehicleName(vehicle).." (ID: "..getElementModel(vehicle)..")")
				end
				if (getPedOccupiedVehicleSeat(player) ~= 0) then
					local driver = getVehicleOccupant(vehicle, 0)
					driver = (driver) and getPlayerName(driver):gsub("#%x%x%x%x%x%x", "")
					guiSetText(aTab1.VehicleHealth, string.format("Состояние: %s%%. Водитель: %s", math.ceil(getElementHealth(vehicle)/10), (driver or "none")))
				else
					guiSetText(aTab1.VehicleHealth, "Состояние: "..math.ceil(getElementHealth(vehicle)/10).."%")
				end
			else
				guiSetText ( aTab1.Vehicle, "Пешком" )
				guiSetText ( aTab1.VehicleHealth, "Состояние: 0%" )
			end
			if ( aPlayers[player]["admin"] ) then
				guiSetText(aTab1.Admin, "Забрать админ права")
			else
				guiSetText(aTab1.Admin, "Выдать админ права")
			end
			return player
		end
	end
...
function aClientSync ( type, table )
	...
	elseif ( type == "messages" ) then
		...
		guiSetText ( aTab1.Messages, table["unread"].."/ "..table["total"].." репортов" )
...
function setPlayerDetails(plr, bdData)
    guiSetText(aTab1.MoneyBankRub, "Обычный счет: "..convertNumber(bdData.RUB).."₽")
    guiSetText(aTab1.Donate, "Донат счет: "..convertNumber(bdData.DONATE).."₽")
end
addEvent("setPlayerDetails", true)
addEventHandler("setPlayerDetails", root, setPlayerDetails)
		...
		if ( getElementParent ( source ) == aTab1.Tab ) then
			...
			elseif ( getElementType ( source ) == "gui-button" )  then
				...
				if ( guiGridListGetSelectedItem ( aTab1.PlayerList ) == -1 ) then
					if (source ~= aTab1.GiveVehicle) and (source ~= aTab1.GiveWeapon) then
						aMessageBox("error", "Не выбран игрок!")
					end
				else
					...
					elseif ( source == aTab1.SetHealth ) then aInputBox ( "Выдача жизней", "Введите число от 1 до 100", "100", "setHealth", player )
					elseif ( source == aTab1.SetArmour ) then aInputBox ( "Выдача брони", "Введите число от 1 до 100", "100", "setArmor", player )
					...
					elseif ( source == aTab1.SetMoney ) then aInputBox ( "Выдача наличных", "Введите сумму", "0", "setMoney", player )
                    

                    --. Выдача обнуление
                    elseif ( source == aTab1.giveDonate ) then aInputBox ( "Выдача доната", "Введите сумму", "0", "setDonateMoney", player )
                    elseif ( source == aTab1.giveBank ) then aInputBox ( "Выдача денег на Банковский счет", "Введите сумму", "0", "setBankMoney", player )
                    --
                    elseif ( source == aTab1.delallDonate) then aMessageBox ( "Подтверждение", "Вы уверены что хотите обнулить донат ед. у игрока "..name.."?", "setdonateminus", player )  
                    elseif ( source == aTab1.delallBank) then aMessageBox ( "Подтверждение", "Вы уверены что хотите обнулить банк у игрока "..name.."?", "setbankminus", player )    
                    --. Парк. места  
                    elseif ( source == aTab1.givePark ) then aInputBox ( "Добавить парковочные места", "Введите число", "0", "setparkmesta", player ) 
                    elseif ( source == aTab1.minusPark ) then aInputBox ( "Убрать парковочные места", "Введите число сколько убрать", "0", "minuspark", player )
			...
			elseif ( source == aTab1.PlayerList ) then
				if ( guiGridListGetSelectedItem( aTab1.PlayerList ) ~= -1 ) then
					...
					guiSetText ( aTab1.Groups, "ACL: N/A" )
					...
					guiSetText ( aTab1.Money, "Наличка: 0" )
					guiSetText ( aTab1.MoneyBankRub, "Банк: 0" )
					guiSetText ( aTab1.Donate, "Донат счет: 0" )
					...
					guiSetText ( aTab1.Area, "Местоположение: Неизвестно" )
